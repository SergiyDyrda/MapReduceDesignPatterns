...
public class Driver extends Configured implements Tool {
    ...
    public static final String MULTIPLE_OUTPUTS_ANONYMIZE = "anonym";
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setReducerClass(AnonymizingDistinctMergedReducer.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("output/metapatterns/distinctAnonymize"));
